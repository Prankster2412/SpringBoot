...
public class Products {
	...
	public Products(String productId,String productName,String shortDesc,String longDesc,float unitPrice,float retailPrice,
			String category,String subCategory,String dimensions,Date modifyTs,Date createTs,String createProgId,String modifyProgId) {
		super();
		this.productId=productId;
		this.productName=productName;
		this.shortDesc=shortDesc;
